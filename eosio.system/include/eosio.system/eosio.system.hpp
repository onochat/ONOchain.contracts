...
public:
    ...
    static constexpr eosio::name bpay_account{"ono.bpay"_n};
    static constexpr eosio::name social_account{"ono.social"_n};
    static constexpr eosio::name opfund_account{"ono.opfund"_n};
    static constexpr eosio::name usfund_account{"ono.userfund"_n};
