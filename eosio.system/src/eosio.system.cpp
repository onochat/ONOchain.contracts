...
namespace eosiosystem {
    ...
    void system_contract::setram(uint64_t max_ram_size) {
        ...
        eosio_assert(_gstate.max_ram_size < max_ram_size,
    ...
    void system_contract::setalimits(name account, int64_t ram, int64_t net, int64_t cpu) {
        ...
        if (vitr != _voters.end()) {
            ...
            eosio_assert(!(ram_managed || net_managed || cpu_managed),
...
(newaccount)(updateauth)(deleteauth)(linkauth)(unlinkauth)(canceldelay)(onerror)(setabi)
        // eosio.system.cpp
        (init)(setprods)(setram)(setramrate)(setparams)(setpriv)(setalimits)(setacctram)(setacctnet)(setacctcpu)
